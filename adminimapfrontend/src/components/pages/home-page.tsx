      ...
      <header className="w4-header w4-theme">
        <div className="w4-navbar w4-flex">
          ...
          <div className="w4-tab-container">
            <div id="button-tab-search" className={`w4-button w4-button-tab ${getTabButtonClassActive(Tabs.Search)}`} onClick={() => setTabSearchParameter(Tabs.Search)}>
            ...
            <div id="button-tab-note" className={`w4-button w4-button-tab ${getTabButtonClassActive(Tabs.Note)}`} onClick={() => setTabSearchParameter(Tabs.Note)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" height="20" width="20" fill="#ffffff">
            ...
            <div id="button-tab-map" className={`w4-button w4-button-tab ${getTabButtonClassActive(Tabs.Map)}`} style={{display: "none"}} onClick={() => setTabSearchParameter(Tabs.Map)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" height="20" width="20" fill="#ffffff">
